...
const Upload = () => {
  ...
  return (
    <section className="relative flex min-h-[calc(100svh-81px)] items-center overflow-hidden px-5 py-0 sm:px-8 lg:px-10 xl:px-12 2xl:px-16">
      ...
      <div className="mx-auto flex w-full max-w-[1040px] flex-col justify-center">
        <Motion.div
        ...
        >
          ...
          >
            ...
            <p className="mx-auto mt-2.5 max-w-2xl text-sm leading-6 text-[#5f5f5f] sm:text-[0.98rem]">
              Upload an MP3, WAV, M4A, or MP4 recording. Once selected, Scribo will process the file and move you straight into the result view.
            </p>
            ...
            <div className="mx-auto mt-4 flex max-w-2xl flex-wrap justify-center gap-2.5 text-sm text-[#5f5f5f]">
              ...
              <span className="rounded-full border border-black/8 bg-white px-3 py-1.5">
                {file ? formatFileSize(file.size) : "Supports large recordings"}
              </span>
              <span className="rounded-full border border-black/8 bg-white px-3 py-1.5">
